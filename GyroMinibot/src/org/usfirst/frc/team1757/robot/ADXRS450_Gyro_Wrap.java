 ...
 */
public class ADXRS450_Gyro_Wrap extends GyroBase implements Gyro, PIDSource, LiveWindowSendable {
   ...
   */
  public ADXRS450_Gyro_Wrap(SPI.Port port) {
    m_spi = new SPI(port);
    ...
    LiveWindow.addSensor("ADXRS450_Gyro_Wrap", port.getValue(), this);
  }
  ...
  public double getAngle() {
    ...
    return m_spi.getAccumulatorValue() * kDegreePerSecondPerLSB * kSamplePeriod  *-1;
  }
